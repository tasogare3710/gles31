...
pub unsafe fn DebugMessageCallbackKHR(
    ...
    __gl_imports::mem::transmute::<
        _,
        extern "system" fn(types::GLDEBUGPROCKHR, *const __gl_imports::raw::c_void) -> (),
    >(storage::DebugMessageCallbackKHR.f)(callback, userParam)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub unsafe fn GetPointervKHR(
    ...
    __gl_imports::mem::transmute::<
        _,
        extern "system" fn(types::GLenum, *const *mut __gl_imports::raw::c_void) -> (),
    >(storage::GetPointervKHR.f)(pname, params)
}
#[allow(non_snake_case, unused_variables, dead_code)]
#[inline]
...
pub mod DebugMessageCallback {
    ...
    {
        unsafe {
            storage::DebugMessageCallback =
                FnPtr::new(metaloadfn(&mut loadfn, "glDebugMessageCallback", &[]))
        }
    }
}
...
pub mod DebugMessageCallbackKHR {
    ...
    {
        unsafe {
            storage::DebugMessageCallbackKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glDebugMessageCallbackKHR", &[]))
        }
    }
}
...
pub mod DebugMessageControl {
    ...
    {
        unsafe {
            storage::DebugMessageControl =
                FnPtr::new(metaloadfn(&mut loadfn, "glDebugMessageControl", &[]))
        }
    }
}
...
pub mod DebugMessageControlKHR {
    ...
    {
        unsafe {
            storage::DebugMessageControlKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glDebugMessageControlKHR", &[]))
        }
    }
}
...
pub mod DebugMessageInsert {
    ...
    {
        unsafe {
            storage::DebugMessageInsert =
                FnPtr::new(metaloadfn(&mut loadfn, "glDebugMessageInsert", &[]))
        }
    }
}
...
pub mod DebugMessageInsertKHR {
    ...
    {
        unsafe {
            storage::DebugMessageInsertKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glDebugMessageInsertKHR", &[]))
        }
    }
}
...
pub mod GetDebugMessageLog {
    ...
    {
        unsafe {
            storage::GetDebugMessageLog =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetDebugMessageLog", &[]))
        }
    }
}
...
pub mod GetDebugMessageLogKHR {
    ...
    {
        unsafe {
            storage::GetDebugMessageLogKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetDebugMessageLogKHR", &[]))
        }
    }
}
...
pub mod GetObjectLabelKHR {
    ...
    {
        unsafe {
            storage::GetObjectLabelKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetObjectLabelKHR", &[]))
        }
    }
}
...
pub mod GetObjectPtrLabel {
    ...
    {
        unsafe {
            storage::GetObjectPtrLabel =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetObjectPtrLabel", &[]))
        }
    }
}
...
pub mod GetObjectPtrLabelKHR {
    ...
    {
        unsafe {
            storage::GetObjectPtrLabelKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glGetObjectPtrLabelKHR", &[]))
        }
    }
}
...
pub mod GetPointerv {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::GetPointerv = FnPtr::new(metaloadfn(&mut loadfn, "glGetPointerv", &[])) }
    }
}
...
pub mod ObjectLabel {
    ...
    where
        F: FnMut(&'static str) -> *const raw::c_void,
    {
        unsafe { storage::ObjectLabel = FnPtr::new(metaloadfn(&mut loadfn, "glObjectLabel", &[])) }
    }
}
...
pub mod ObjectPtrLabelKHR {
    ...
    {
        unsafe {
            storage::ObjectPtrLabelKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glObjectPtrLabelKHR", &[]))
        }
    }
}
...
pub mod PopDebugGroupKHR {
    ...
    {
        unsafe {
            storage::PopDebugGroupKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glPopDebugGroupKHR", &[]))
        }
    }
}
...
pub mod PushDebugGroupKHR {
    ...
    {
        unsafe {
            storage::PushDebugGroupKHR =
                FnPtr::new(metaloadfn(&mut loadfn, "glPushDebugGroupKHR", &[]))
        }
    }
}
